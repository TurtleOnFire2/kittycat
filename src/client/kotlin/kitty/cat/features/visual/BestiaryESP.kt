...
object BestiaryESP : Feature("Bestiary ESP", "", Categories.Category.VISUAL) {
    ...
    private fun getEntityTextureString(entity: Entity): String? {
        val player = entity as? Player ?: return null
        val encoded = player.gameProfile.properties["textures"].firstOrNull()?.value ?: return null
        ...
        val url = runCatching {
            ...
            com.google.gson.JsonParser.parseString(json).asJsonObject["textures"]?.asJsonObject
                ?.get("SKIN")?.asJsonObject?.get("url")?.asString
        }.getOrNull()
    ...
    fun register() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register { client ->
            ...
            mc.level?.entitiesForRendering()?.forEach { entity ->
                ...
                val texture = if (texturedMobs.isEmpty()) null else getEntityTextureString(entity)
